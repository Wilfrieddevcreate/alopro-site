...
const departments = [
  {
    ...
    items: ["services.dev.item1", "services.dev.item2", "services.dev.item3", "services.dev.item4"],
    number: "01",
    color: "#1F6FEB",
    icon: (
  ...
  },
  {
    ...
    items: ["services.research.item1", "services.research.item2", "services.research.item3", "services.research.item4"],
    number: "02",
    color: "#1F6FEB",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    items: ["services.training.item1", "services.training.item2", "services.training.item3", "services.training.item4"],
    number: "03",
    color: "#059669",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-gray-50 py-16 dark:bg-[#060e1e] sm:py-24">
      <div ref={ref} className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          <div className="max-w-xl">
            ...
            >
              {t("services.title")}{" "}
              <span className="text-[#1F6FEB]">{t("services.titleHighlight")}</span>
            </motion.h2>
          </div>
            ...
            >
              ...
              <div className="mb-8 flex items-center justify-between">
                <motion.span
                  ...
                  transition={{ duration: 0.5, delay: 0.7 + i * 0.15, type: "spring", stiffness: 200 }}
              ...
              <ul className="space-y-3">
                {dept.items.map((key, j) => (
                  ...
                  >
                    ...
                    <span className="text-[13px] leading-[1.5] text-gray-600 dark:text-gray-400">{t(key)}</span>
                  </motion.li>
                ))}
              </ul>
        ...
        <motion.div
          ...
          animate={isInView ? { opacity: 1, y: 0, filter: "blur(0px)" } : {}}
          transition={{ duration: 0.6, delay: 1.6, ease: [0.22, 1, 0.36, 1] as [number, number, number, number] }}
