...
export function CTASection() {
  ...
  return (
    <section id="contact" className="bg-white py-16 dark:bg-[#000814] sm:py-24">
      <div ref={ref} className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <span className="h-px w-6 bg-[#1F6FEB]" />
            <p className="text-[12px] font-semibold uppercase tracking-[0.2em] text-[#1F6FEB]">
              Contact
            </p>
            <span className="h-px w-6 bg-[#1F6FEB]" />
          </motion.div>
          ...
          >
            {t("cta.title")}{" "}
            <span className="text-[#1F6FEB]">{t("cta.titleHighlight")}</span>
          </motion.h2>
          ...
          >
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 rounded-lg bg-[#1F6FEB] px-6 py-3 text-[14px] font-semibold text-white transition-colors duration-150 hover:bg-[#1a5fd4]"
            >
              {t("cta.button")}
