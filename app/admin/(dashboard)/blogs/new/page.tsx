...
import type { BlogCategory, BlogStatus } from "@/src/types/blog";
  ...
  const handleGenerate = async (lang: "fr" | "en") => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        alert("Erreur : " + (err.error || "Échec de la génération"));
        return;
      }
    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-[28px] font-bold text-white">Nouvel article</h1>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-[14px] text-white placeholder-gray-600 outline-none focus:border-[#1F6FEB]/50"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                className="w-full resize-y rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-3 font-mono text-[13px] text-white placeholder-gray-600 outline-none focus:border-[#1F6FEB]/50"
              />
            </div>
            <div>
              ...
              <input
                ...
                maxLength={155}
                placeholder="Description pour les moteurs de recherche (max 155 car.)"
                className="w-full rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-[14px] text-white placeholder-gray-600 outline-none focus:border-[#1F6FEB]/50"
              />
            </div>
            <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={10}
                placeholder="<h2>Subtitle</h2><p>Content...</p>"
                className="w-full resize-y rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-3 font-mono text-[13px] text-white placeholder-gray-600 outline-none focus:border-[#1F6FEB]/50"
              />
            </div>
            <div>
              ...
              <input
                ...
                maxLength={155}
                placeholder="Description for search engines (max 155 chars)"
                className="w-full rounded-lg border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-[14px] text-white placeholder-gray-600 outline-none focus:border-[#1F6FEB]/50"
              />
            </div>
            <div>
